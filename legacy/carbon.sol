...
contract Carbon is Ownable, ERC721ABurnable{
    ...
    string private _baseTokenURI = TokenConfig.URI;

    constructor() ERC721A(TokenConfig.NAME, TokenConfig.SYMBOL) Ownable(msg.sender){}

    function mint_plus(address to, uint256 quantity, string memory bid, string memory ipfs_data) external payable onlyOwner {
